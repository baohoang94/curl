<?php
	if (!empty($_POST)) {
		$data = '{"statusCode":"00","amount":4500,"merchantName":"sab","merchantId":"sabmerchant","transactionDate":"20190322113417","orderId":"'.$_POST['orderid'].'","statusMessage":"Tru tien thanh cong","productId":""}';
