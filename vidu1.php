...
<table border="1" width="50%">
	<caption>Kết quả xổ số <?php echo $result['day']; ?></caption>
	<tr>
		<th>Đặc biệt</th>
		<td><?php echo $result['dacbiet']; ?></td>
	</tr>
	<tr>
		<th>Giải nhất</th>
		<td><?php echo $result['giainhat']; ?></td>
	</tr>
	<tr>
		<th>Giải nhì</th>
		<td><?php echo $result['giainhi1'].' - '.$result['giainhi2']; ?></td>
	</tr>
	<tr>
		<th>Giải ba</th>
		<td><?php echo $result['giaiba1'].' - '.$result['giaiba2'].' - '.$result['giaiba3'].' - '.$result['giaiba4'].' - '.$result['giaiba5'].' - '.$result['giaiba6']; ?></td>
	</tr>
	<tr>
		<th>Giải tư</th>
		<td><?php echo $result['giaitu1'].' - '.$result['giaitu2'].' - '.$result['giaitu3'].' - '.$result['giaitu4']; ?></td>
	</tr>
	<tr>
		<th>Giải năm</th>
		<td><?php echo $result['giainam1'].' - '.$result['giainam2'].' - '.$result['giainam3'].' - '.$result['giainam4'].' - '.$result['giainam5'].' - '.$result['giainam6']; ?></td>
	</tr>
	<tr>
		<th>Giải sáu</th>
		<td><?php echo $result['giaisau1'].' - '.$result['giaisau2'].' - '.$result['giaisau3']; ?></td>
	</tr>
	<tr>
		<th>Giải bảy</th>
		<td><?php echo $result['giaibay1'].' - '.$result['giaibay2'].' - '.$result['giaibay3'].' - '.$result['giaibay4']; ?></td>
	</tr>
</table>